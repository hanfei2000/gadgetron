    ...
    <xsl:template match="/">
        <ismrmrdHeader xsi:schemaLocation="http://www.ismrm.org/ISMRMRD ismrmrd.xsd"
            ...
            <encoding>
                ...
                <xsl:if test="siemens/MEAS/sKSpace/ucTrajectory = 2">
                    <trajectoryDescription>
                        <identifier>RadialTSE932</identifier>
                        <userParameterLong>
                            <name>radialviews</name>
                            <value>
                                <xsl:value-of select="siemens/MEAS/sKSpace/lRadialViews"/>
                            </value>
                        </userParameterLong>
                        <comment>Radial TSE WIP932 by Fei Han [ fei.han@siemens-healthineers.com ]
                        </comment>
                    </trajectoryDescription>
                </xsl:if>
                ...
                <encodedSpace>
                    <matrixSize>
                        <x>
                            <xsl:value-of select="siemens/YAPS/iRoFTLength"/>
                        </x>
                        <y>
                            <xsl:value-of select="siemens/YAPS/iRoFTLength"/>
                        </y>
